...
ZKC_API ZkVec3f const* ZkBspTree_getLightPoints(ZkBspTree const* slf, ZkSize* count);
ZKC_API uint64_t const* ZkBspTree_getLeafNodeIndices(ZkBspTree const* slf, ZkSize* count);
ZKC_API ZkBspNode const* ZkBspTree_getNodes(ZkBspTree const* slf, ZkSize* count);
