...
CZK_API ZkMaterial const* ZkMesh_getMaterial(ZkMesh const* slf, ZkSize i);
...
CZK_API ZkLightMap const* ZkMesh_getLightMap(ZkMesh const* slf, ZkSize i);
...
CZK_API ZkPolygon const* ZkMesh_getPolygon(ZkMesh const* slf, ZkSize i);
...
CZK_API int16_t ZkPolygon_getSectorIndex(ZkPolygon const* slf);
